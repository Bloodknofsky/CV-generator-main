...
if (sizeof($_POST) > 0) {
    ...
    $pdf->SetFillColor(0, 0, 0); // Light gray background
    $pdf->SetTextColor(220, 220, 220); // Dark gray text color 
...
";
    ...
    ob_end_clean();
    $pdf->Output('cv_temp_02.pdf', 'D'); // Download the PDF file with the name "cv.pdf"
