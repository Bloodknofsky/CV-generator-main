...
$pdf->SetFont('times', 'B', 24); // Heading font
$pdf->SetFont('helvetica', '', 12); // Content font

// Set background color
$pdf->SetFillColor(255, 255, 204); // Pale yellow background
...
";
    ...
    ob_end_clean();
    $pdf->Output('cv_temp_03.pdf', 'D'); // Download the PDF file with the name "cv.pdf"
